...
public class JhipstershopinKafkaResourceIT {
    ...
    @Autowired
    private JhipstershopinKafkaProducer producer;

    @Autowired
    private JhipstershopinKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipstershopinKafkaResource kafkaResource = new JhipstershopinKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipstershopin-kafka/publish?message=test"))
